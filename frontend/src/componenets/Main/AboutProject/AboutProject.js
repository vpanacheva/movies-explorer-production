    ...
    <section className="about-project" id="aboutproject">
      ...
      <div className="about-project__timeline">
        <div className="about-project__week-one">
          <h4 className="about-project__timeline-title about-project__timeline-title_backend">
            1 неделя
          </h4>
        ...
        <div className="about-project__week-four">
          <h4 className="about-project__timeline-title about-project__timeline-title_frontend">
            4 недели
          </h4>
